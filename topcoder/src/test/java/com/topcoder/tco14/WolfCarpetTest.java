...
public class WolfCarpetTest {
	...
	public void testCount() {
		...
		assertEquals(750000002000000001l, wolfCarpet.count(0,0,1000000000,1000000000));
		assertEquals(6979871694045002l, wolfCarpet.count(81695509,209408464,949118329,220137366));
	}
}
