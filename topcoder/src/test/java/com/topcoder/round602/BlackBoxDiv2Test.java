...
public class BlackBoxDiv2Test {
    ...
    public static Collection<String[]> data() {
        return Arrays.asList(new String[][]{
                    ...
                    {"1", "...", "....."},
                    {"0", "...", "BBB"},
                    {"16081", "...BB.B....", "B.B.B.B.B"},
                    {"771030153", "BBBBB.BBBBBBBBB.BBBBBBB.BBBB.B.BB..BB.B.BBBBBBBBBB",
                        ".B.BBB..BBBBBB.BBBB.B...BBBB.BB.BBBBBBBBBB.....BBB"},
                    {"795333334", "BBBB...BB.BBB.BBBBBB.BBBB..BB.BB..BBBB.BBBBBBB..B.",
                        "BBBBBBBBBBBBBBBBBBBBBBBBBBB..BBBBBBBBBBBBBBB.BBBB"},});
    }
    String front, side;
    int expectedResult;
    ...
    public void testCount() {
        BlackBoxDiv2_2 bb = new BlackBoxDiv2_2();
