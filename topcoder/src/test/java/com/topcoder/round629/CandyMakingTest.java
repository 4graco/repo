...
public class CandyMakingTest {
	...
	public void testFindSuitableDensity() {
		...
		assertEquals(0.0, a.findSuitableDensity(new int[] { 5 }, new int[] { 1000 }), 0);
		assertEquals(1000.0, a.findSuitableDensity(new int[] { 10, 10 }, new int[] { 1000, 2000 }), 0);
		assertEquals(5250.0, a.findSuitableDensity(new int[] { 10, 20, 40 }, new int[] { 4000, 2000, 1000 }), 0);
		assertEquals(
		        983673.2727272725,
		...
		assertEquals(999999.9999673415, a.findSuitableDensity(new int[] { 30621, 30620, 2 }, new int[] { 1, 1, 1000000 }), 0);
	}
}
